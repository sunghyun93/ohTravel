...
public interface ManagerPkgService {
// 패키지 상세 추가 insert 및 select 문들
	...
	int insertPkgScheDetail(Pkage_sche_detailDTO pkage_sche_detailDTO) throws Exception;
	List<Air_ScheduleDTORM> selectAirScheConnectedPkgDetail(Map<String, Object> map) throws Exception;
	int insertPkgFlightSche(Pkage_flightScheDTO pkage_flightScheDTO) throws Exception;
...
//	패키지 상세 관련 delete
	int deletePkgDetailWithAll(Integer pkage_dt_id) throws Exception;
}
