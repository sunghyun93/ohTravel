	...
	<div class="container" id="container">
		<div class="inr">
			<div class="contents" id="contents">
				<form name="findPassword" id="findPassword" method="post">
...
$(document).ready(function() {
	...
	$("#find_button").click(function() {
        ...
        if(idCheck && nameCheck && bdCheck && telCheck) {
        	$("#findPassword").attr("action", "${pageContext.request.contextPath}/member/findPassword");
       		$("#findPassword").submit();
        }
