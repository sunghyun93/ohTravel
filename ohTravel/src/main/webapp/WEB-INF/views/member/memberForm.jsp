					...
					<div class="terms_wrap">
						<div class="checkbox_group">
							...
							<div class="form_holder check mt20">
								<input type="checkbox" id="check_all" class="inpt_checkbox"> 
								<label for="check_all" class="label_checkbox">전체동의</label>
							</div>
							<!-- Oh!Travel 이용 약관 동의  -->
							<div class="form_holder check mt20">
								<input type="checkbox" id="FT05" class="inpt_checkbox normal">
							...
							<!-- 개인정보 수집 및 이용에 대한 동의 -->		
							<div class="form_holder check mt20">
								<input type="checkbox" id="MJ05" class="inpt_checkbox normal">
							...
							<div class="form_holder check mt20">
								<input type="checkbox" id="MJ01" class="inpt_checkbox normal">
							...
							<div class="form_holder check mt20">
								<input type="checkbox" id="MJ02" class="inpt_checkbox normal">
							...
							<div class="form_holder check mt20">
								<input type="checkbox" id="MJ03" class="inpt_checkbox normal">
							...
							<div class="form_holder check mt20">
								<input type="checkbox" id="MJ04" class="inpt_checkbox normal">
