	...
	function reservationAir(){
		$.ajax({
			...
			success : function(data){
				...
				console.log(data);
					let str ="";
					str = "<thead><tr><th>예약번호</th><th>아이디</th><th>좌석등급</th><th>비행편보기</th><th>예약일자</th><th>결제금액</th></tr></thead>";
				$.each(data, function(index,item){
					...
					str += "<td><a href='#myModal3'data-toggle='modal' onclick='mem_rev3("+item.reservation_id+")' style='color:pink'>비행편확인</a></td>";	
					/* if(item.air_gubun == 0){
