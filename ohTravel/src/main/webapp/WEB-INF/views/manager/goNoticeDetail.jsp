			...
			<form method="post" id="form">
				<div class="row">
					<div class="col-lg-12 col-sm-12 text-lg-end text-center">
						<input type="button" class="btn btn-primary mb-2" style="float: right;" onclick="location.href='goNotice?currentPage=${currentPage}'"	value="돌아가기">
					</div>
					<table border="1" class="table table-striped">
						<c:forEach var="noticeDetail" items="${noticeDetail }">
							<tr>
								<td class="name">글번호</td>
								<td>${noticeDetail.notice_id }</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><textarea class="form-control" aria-label="Disabled input example" disabled readonly style="min-height: 400px">${noticeDetail.notice_content }</textarea></td>
							</tr>
							<tr>
