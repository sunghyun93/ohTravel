...
<body>
	...
	<hr>
		<div class="mb-3">
			<label for="ticket_name" class="form-label">도착공항 이름</label>
			<input type="text" class="form-control" name="end_airport_name" id="end_airport_name" required="required" placeholder="도착공항명 입력">
		</div>
		<div class="mb-3">
